...
namespace Laba8.Forms.OtherForms
{
    public partial class WorkersControls : UserControl
    {
        ...
        {
            InitializeComponent();
            using (StreamWriter sw = new StreamWriter("workersData.txt", true)) { }
        ...
        /// <summary>
        /// Сортирует элемент WorkersListBox типа ListBox по полным именам работников. 
        /// </summary>
        ...
        /// <summary>
        /// Сохраняет в текстовый файл данные о работниках перед закрытием программы.
        /// </summary>
